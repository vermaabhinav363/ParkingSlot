 ...
 <body>
      ...
      <div class="message">
          <div class="container">
              ...
              <p class="text-center">Browse through hundreds of parking slots owned by AutoPARK.</p>
        ...
        <div class="info">
          <input class="fname" type="text" name="Locate" placeholder="Location" required>&nbsp&nbsp
          Date
          <input class="fname" type="date" name="Date"    required>&nbsp&nbsp
