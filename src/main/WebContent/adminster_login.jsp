...
try{
	...
	ResultSet  i =st.executeQuery("SELECT * from admins WHERE Email = " + "'" +  email + "'" + " and " + "pass = " + "'" + pass + "'"  );
	
	if(i.next()){
		out.println("<html><meta http-equiv=\"refresh\" \r\n"
				+ "        content=\"5; url = AdminBoard.jsp\" /><body><b>Logged In"
					+ "</b></body></html>");
		
	}
	else{
		out.println("<html><meta http-equiv=\"refresh\" \r\n"
				+ "        content=\"5; url = admin_login.jsp\" /><body><b>Wrong Credential"
					+ "</b></body></html>");	
	}
