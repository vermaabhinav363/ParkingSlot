...
<%
String Value     = request.getParameter("valueR");
...
try {
	...
	t1=t1-t2;
		...
		out.println("<html><meta http-equiv=\"refresh\" \r\n"
				+ "        content=\"1; url = http://localhost:8080/BasicWebApplication/examples/notifications.jsp\" /><body><b>Not Enough Funds" + "</b></body></html>");
	}
