...
try{
	...
	ResultSet  i =st.executeQuery("SELECT * from users WHERE Email = " + "'" +  email + "'" + " and " + "Pass = " + "'" + pass + "'"  );
	
	if(i.next()){
		out.println("<html><meta http-equiv=\"refresh\" \r\n"
				+ "        content=\"5; url = UserBoard.jsp\" /><body><b>Logged In"
					+ "</b></body></html>");
		
	}
	else{
		out.println("<html><meta http-equiv=\"refresh\" \r\n"
				+ "        content=\"5; url = default1.html\" /><body><b>Wrong Credential"
					+ "</b></body></html>");	
	}
